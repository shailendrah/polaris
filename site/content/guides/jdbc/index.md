...
# under the License.
#
linkTitle: "Backend: JDBC, Oracle"
title: "Getting Started with Apache Polaris, Relational JDBC, Oracle and Spark SQL"
weight: 100
tags:
   - backend
   - jdbc
...
2. Ensure a reachable Oracle database instance is available, then start the docker compose group by running the following command from the root of the repository:

    ```shell
    export QUARKUS_DATASOURCE_JDBC_URL=jdbc:oracle:thin:@//oracle:1521/FREEPDB1
    export QUARKUS_DATASOURCE_USERNAME=polaris
    export QUARKUS_DATASOURCE_PASSWORD=polaris
    export ASSETS_PATH=$(pwd)/site/content/guides/assets/
    export CLIENT_ID=root
    export CLIENT_SECRET=s3cr3t
    docker compose -f site/content/guides/jdbc/docker-compose-bootstrap-db.yml -f site/content/guides/jdbc/docker-compose.yml up
    ```
