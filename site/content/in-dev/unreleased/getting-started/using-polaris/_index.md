...
* To shut down a locally-deployed Polaris server and clean up all related Docker containers, run the command listed below. Polaris running on Gradle will terminate when the Gradle process terminates.
```shell
