...
To start using Polaris in Docker, point the bootstrap and runtime compose files at a reachable Oracle database instance. Provide the JDBC URL, username, and password via environment variables; the bootstrap step initializes the Polaris schema before Polaris starts.
