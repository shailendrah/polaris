...
-- under the License.
--
-- Schema version 4 for Apache Polaris on Oracle.
--
-- Prerequisite: a POLARIS_SCHEMA user (schema) must exist and the connecting
-- user must have CREATE ANY TABLE / CREATE ANY INDEX privileges, or be
-- POLARIS_SCHEMA itself. Example DBA setup:
--   CREATE USER POLARIS_SCHEMA NO AUTHENTICATION;
--   GRANT UNLIMITED TABLESPACE TO POLARIS_SCHEMA;
--   GRANT CREATE ANY TABLE, CREATE ANY INDEX TO <bootstrap_user>;
...
CREATE TABLE IF NOT EXISTS POLARIS_SCHEMA.ENTITIES (
  ...
  location_without_scheme VARCHAR2(4000),
...
CREATE INDEX IF NOT EXISTS POLARIS_SCHEMA.ix_entities_location
  ON POLARIS_SCHEMA.ENTITIES (realm_id, catalog_id, location_without_scheme);
...
CREATE TABLE IF NOT EXISTS POLARIS_SCHEMA.COMMIT_METRICS_REPORT (
  realm_id VARCHAR2(256) NOT NULL,
  report_id VARCHAR2(256) NOT NULL,
  catalog_id NUMBER(19) NOT NULL,
  table_id NUMBER(19) NOT NULL,
  timestamp_ms NUMBER(19) NOT NULL,
  principal_name VARCHAR2(512),
  request_id VARCHAR2(256),
  otel_trace_id VARCHAR2(64),
  otel_span_id VARCHAR2(64),
  report_trace_id VARCHAR2(256),
  snapshot_id NUMBER(19) NOT NULL,
  sequence_number NUMBER(19),
  operation VARCHAR2(64) NOT NULL,
  added_data_files NUMBER(19) NOT NULL,
  removed_data_files NUMBER(19) NOT NULL,
  total_data_files NUMBER(19) NOT NULL,
  added_delete_files NUMBER(19) NOT NULL,
  removed_delete_files NUMBER(19) NOT NULL,
  total_delete_files NUMBER(19) NOT NULL,
  added_equality_delete_files NUMBER(19) NOT NULL,
  removed_equality_delete_files NUMBER(19) NOT NULL,
  added_positional_delete_files NUMBER(19) NOT NULL,
  removed_positional_delete_files NUMBER(19) NOT NULL,
  added_records NUMBER(19) NOT NULL,
  removed_records NUMBER(19) NOT NULL,
  total_records NUMBER(19) NOT NULL,
  added_file_size_bytes NUMBER(19) NOT NULL,
  removed_file_size_bytes NUMBER(19) NOT NULL,
  total_file_size_bytes NUMBER(19) NOT NULL,
  total_duration_ms NUMBER(19) NOT NULL,
  attempts NUMBER(10) NOT NULL,
  metadata CLOB,
  CONSTRAINT pk_commit_metrics_report PRIMARY KEY (realm_id, report_id)
);

CREATE INDEX IF NOT EXISTS POLARIS_SCHEMA.ix_commit_metrics_table_ts
  ON POLARIS_SCHEMA.COMMIT_METRICS_REPORT (realm_id, catalog_id, table_id, timestamp_ms);

CREATE TABLE IF NOT EXISTS POLARIS_SCHEMA.SCAN_METRICS_REPORT (
  realm_id VARCHAR2(256) NOT NULL,
  report_id VARCHAR2(256) NOT NULL,
  catalog_id NUMBER(19) NOT NULL,
  table_id NUMBER(19) NOT NULL,
  ...
  projected_field_ids CLOB,
  projected_field_names CLOB,
  result_data_files NUMBER(19) NOT NULL,
  result_delete_files NUMBER(19) NOT NULL,
  total_file_size_bytes NUMBER(19) NOT NULL,
  total_data_manifests NUMBER(19) NOT NULL,
  total_delete_manifests NUMBER(19) NOT NULL,
  scanned_data_manifests NUMBER(19) NOT NULL,
  scanned_delete_manifests NUMBER(19) NOT NULL,
  skipped_data_manifests NUMBER(19) NOT NULL,
  skipped_delete_manifests NUMBER(19) NOT NULL,
  skipped_data_files NUMBER(19) NOT NULL,
  skipped_delete_files NUMBER(19) NOT NULL,
  total_planning_duration_ms NUMBER(19) NOT NULL,
  equality_delete_files NUMBER(19) NOT NULL,
  positional_delete_files NUMBER(19) NOT NULL,
  indexed_delete_files NUMBER(19) NOT NULL,
  total_delete_file_size_bytes NUMBER(19) NOT NULL,
  metadata CLOB,
  CONSTRAINT pk_scan_metrics_report PRIMARY KEY (realm_id, report_id)
);

CREATE INDEX IF NOT EXISTS POLARIS_SCHEMA.ix_scan_metrics_table_ts
  ON POLARIS_SCHEMA.SCAN_METRICS_REPORT (realm_id, catalog_id, table_id, timestamp_ms);
...
SELECT 4 FROM dual WHERE NOT EXISTS (SELECT 1 FROM POLARIS_SCHEMA.VERSION);
