 ...
 * the underlying data store. The goal is to make it really easy to back this using a relational
 * database like Oracle. Each API in this interface need to be atomic.
 */
