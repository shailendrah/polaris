 ...
 *     DockerImageName dockerImageName = containerSpecHelper("my-service", MyTestCode.class)
 ...
 * }
 *
 * <p>The above requires the file {@code my/code/Dockerfile-my-service-version} to be on the classpath,
 * containing just the Docker {@code FROM}, as in a file {@code
 * src/test/resources/my/code/Dockerfile-my-service-version}.
 *
 * {@snippet :
 * FROM docker.io/example/service:1.0.0
 * }
 *
